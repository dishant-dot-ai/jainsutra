...
Use this prompt when building chapter pages **or the index page** for the Gyansaar scripture on JainSutra.org. This design system is derived from the Sutrakritanga series and must be followed exactly.
